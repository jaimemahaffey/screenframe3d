...
echo("");
echo("INSTALLATION:");
echo("1. Position clip on 2020 profile");
echo("2. Mark screw holes");
echo("3. Drill pilot holes or use T-nuts");
echo("4. Secure with 2× M4 screws");
echo("5. Press tube into C-clip opening");
echo("");
echo("FEATURES:");
echo("  • Simple press-fit design");
echo("  • No twist-lock needed");
echo("  • Easy tube insertion/removal");
echo("  • Secure M4 screw mounting");
...
echo("  • 2× M4 screws (10-16mm length)");
echo("  • 2× T-nuts or drill into profile");
echo("===========================================");
